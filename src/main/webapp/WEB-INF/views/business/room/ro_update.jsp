...
<body>
    ...
    <form action="${contextPath}/business/room/ro_update" method="post">
        ...
        숙소 위치: <input type="text" id="pension_pen_addr" name="pension_pen_addr" value="${ro.pension_pen_addr }" readOnly><br>
        ...
        방 사진: <input type="number" id="picture_pic_num" name="picture_pic_num" value="${ro.picture_pic_num }" readOnly >
