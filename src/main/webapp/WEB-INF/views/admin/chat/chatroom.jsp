...
<body>
    ...
    <script>
        ...
        function onConnected() {
            ...
            stompClient.send("/app/chat.addUser", {}, JSON.stringify({sender: '${sessionScope.username}', type: 'JOIN'}));
        }
        ...
        document.getElementById('messageForm').addEventListener('submit', function(e) {
            ...
            stompClient.send("/app/chat.sendMessage", {}, JSON.stringify({sender: '${sessionScope.username}', content: messageContent, type: 'CHAT'}));
