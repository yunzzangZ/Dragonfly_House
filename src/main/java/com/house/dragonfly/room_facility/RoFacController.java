...
public class RoFacController {
    ...
    // 전체 방 시설 조회
    @GetMapping(value = "business/rofac/rofac_listall")
    public ModelAndView rofac_listall() {
        List<RoomFacilityVO> list = service.rofac_listAll();
        ModelAndView mav = new ModelAndView();
        mav.addObject("list", list);
        mav.setViewName("business/rofac/rofac_listall");
        return mav;
    }
    
    // 상세 조회
    @GetMapping(value = "business/rofac/rofac_selectOne")
    public ModelAndView selectOne(int room_ro_num) {
        ...
        mav.setViewName("business/rofac/rofac_selectOne");
        return mav;
    }
    
    // 추가 페이지 이동
    @GetMapping(value = "business/rofac/rofac_insert")
    public String insertForm(Model model) {
        model.addAttribute("roomFacilityVO", new RoomFacilityVO());
        return "business/rofac/rofac_insert";     
    }
    
    // 추가
    @PostMapping(value = "business/rofac/rofac_insert")
    public String insert(RoomFacilityVO rofac_insert, RedirectAttributes rttr) {
        ...
        return "redirect:/business/rofac/rofac_listall";     
    }
    
    // 수정 이동
    @GetMapping(value = "business/rofac/rofac_update")
    public ModelAndView updateForm(@RequestParam("room_ro_num") int room_ro_num) {
        ModelAndView mav = selectOne(room_ro_num);
        mav.setViewName("business/rofac/rofac_update");
        return mav;     
    }
    
    // 수정
    @PostMapping(value = "business/rofac/rofac_update")
